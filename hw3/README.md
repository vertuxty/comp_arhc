...
Часть модулей, необходимых для реализации процессора реализована в файлах в [./cpu-template](./cpu-template/), а именно:
...
Сам процессор необходимо реализовывать в модуле [mips_cpu.v](./cpu-template/mips_cpu.v). Для упрощения
...
Пример использования этого процессора можно найти в файле [cpu_test.v](./cpu-template/cpu_test.v),
